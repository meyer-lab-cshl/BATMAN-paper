...
# Merge columns to format for ImRex
tcr_pmhc_data['cdr3;antigen.epitope'] = tcr_pmhc_data['cdr3b'] + ';' + tcr_pmhc_data['peptide']

tcr_pmhc_data = tcr_pmhc_data[['cdr3;antigen.epitope']]

# Write peptide seqs to output files
tcr_pmhc_data.to_csv('imrex_input_peptides.csv',index=None)
