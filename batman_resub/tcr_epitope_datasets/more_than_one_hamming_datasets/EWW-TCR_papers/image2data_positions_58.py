...
# For mutations in positions 5 and 8
xmin = 973
xmax = 1627.5
ymin = 2489.5
ymax = 3143.5 
...
aa_order_x = ['A','C','E','F','G','I','K','M','N','P','R','T']
aa_order_y = ['T','R','P','N','M','K','I','G','E','C','A']
...
# Export data
mutant_logFC.to_excel('data_from_heatmap_58.xlsx',index=None)
