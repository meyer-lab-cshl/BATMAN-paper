...
# For mutations in positions 4 and 7
xmin = 203.5
xmax = 851.5 
ymin = 1715.5
ymax = 2369.5
...
'''Colorbar'''
# sample equally spaced collinear points between upper (6) & lower (-6) ticks
...
rgb_unscreened = im.getpixel((1032,847))
...
aa_order_y = ['T','R','P','N','M','K','I','F','E','C','A']
...
# Export data
mutant_logFC.to_excel('data_from_heatmap_47.xlsx',index=None)
