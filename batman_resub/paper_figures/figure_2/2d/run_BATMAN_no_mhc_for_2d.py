...
for fold in np.arange(5):
    ...
    # Run BATMAN to infer AA matrix and TCR-specific weights
    ...
    # Get test set mutant2index distance as TCR activation predictor
...
# Save data
aucs_all.to_csv('BATMAN_no_mhc_AUCs.csv')
